...
describe('Central de Atendimento ao Cliente TAT', function () {
    //variável para a funcionalidade .tick
    ...
    it('preenche os campos obrigatórios e envia o formulário', function () {
        ...
        //funcionalidade para parar o relógio do navegador
        cy.clock()
        ...
        //funcionalidade para acelerar o relógio do navegador
    ...
    //exemplo da funcionalidade lodash
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('andersonbenicio@teste.com')
            .should('have.value', 'andersonbenicio@teste.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('71999999999')
    ...
    //utilizando a funcionalidade invoke
    it('exibe e esconde as mensagens de sucesso e erro usando o .invoke', function(){
      ...
      it('preenche a area de texto usando o comando invoke', function(){
        //funcionalidade lodash que ira repetir o texto um determinado de  vezes
